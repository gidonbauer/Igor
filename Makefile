...
FMT_FLAGS = ${shell pkg-config fmt --cflags}
FMT_LIBS = ${shell pkg-config fmt --libs}

IGOR_FILES = Igor/Igor.hpp Igor/Logging.hpp Igor/Macros.hpp Igor/Math.hpp Igor/MemoryToString.hpp Igor/ProgressBar.hpp Igor/StaticVector.hpp Igor/Timer.hpp Igor/TypeName.hpp Igor/Defer.hpp
